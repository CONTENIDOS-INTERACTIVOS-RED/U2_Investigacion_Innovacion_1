  ...
  .container.tarjeta.tarjeta--blanca.px-4.pt-4.px-md-5.pt-md-5.pb-0.overflow-hidden
    .row.justify-content-center.mb-5
      .col-lg-8.mb-lg-0.mb-3
        ...
        .bg-color-1.p-4.mb-5(data-aos="fade-left" style="background-color: #ECD4FE")
          .row.align-items-start
            .col-lg-auto
              img(src="@/assets/curso/temas/26.svg", style="max-width: 90px").mx-auto
            .col-lg
              p.mb-0 En este contexto, como señalan Chesbrough (2020) y Miranda González (2023), el proceso de innovación va más allá de la simple generación de ideas. En un mundo marcado por la transformación digital y los nuevos escenarios globales, descritos por Pérez Calle (2023), es necesario adoptar un enfoque sistemático que permita navegar por las distintas fases del proceso innovador. Tal como destacan Cavazos Arroyo (2021) y Martínez-Gómez (2024), la innovación contemporánea requiere una perspectiva multidisciplinaria que integre elementos técnicos, sociales y organizacionales.
      .col-lg-4.col-7: img(src="@/assets/curso/temas/27.png", style="max-width: 100%")
    .titulo-figura.mb-2(data-aos='fade-right')
      h5 Figura 2.
      span Fases del proceso de innovación
    img.mb-5(src='@/assets/curso/temas/28.svg', alt='')

    #t_2_1.titulo-segundo(data-aos='fade-right').mb-4
      h2 #[span 2.1] Identificación de oportunidades

    .bg-full-width.bg-fondo-3.mb-5
      .p-4.p-md-5
        .row.justify-content-center.mb-5
          .col-lg-4.col-7.mb-lg-0.mb-3: img(src="@/assets/curso/temas/29.png", )
          .col-lg-8
            .bg-color-1.p-4.mb-4(data-aos="fade-left" style="background-color: #D6F5FA")
              .row
                .col-lg-auto
    ...
    #t_2_2.titulo-segundo(data-aos='fade-right').my-5
      h2 #[span 2.2] Metodologías para identificar oportunidades
    ...
    .bg-full-width.bg-fondo-3.mb-5
      .p-4.p-md-5
        #t_2_3.titulo-segundo(data-aos='fade-right').my-5
          h2 #[span 2.3] Ideación: Generación, evaluación y selección de ideas
        ...
        h3 Proceso de generación de ideas
        p La generación de ideas se basa en la integración de técnicas y espacios que favorezcan la creatividad. Es importante implementar metodologías que estructuren este proceso y maximicen la diversidad de perspectivas.
        .row.justify-content-center.align-items-stretch.mb-5
          .col-lg-6.mb-4(data-aos="zoom-in-up")
            .custom-image-card.h-100
    ...
    TabsC.color-acento-contenido.mb-5
      .tabs-content.border.px-4.p-md-5.py-3(titulo="Sector industrial: caso de empresa manufacturera" :icon="require('@/assets/bullets/icon-tab-c-3.svg')" )
        .row.align-items-center
          .col-md-6.col-lg-7.col-xl-8.mb-4.mb-md-0.order-2
            ...
            p Resultados: reducción del 25% en desperdicios mediante 12 proyectos seleccionados.
        
          .col-md-6.col-lg-5.col-xl-4.order-1
            figure(data-aos="zoom-in")
              img(src='@/assets/curso/temas/45.png', alt='')
      .tabs-content.border.px-4.p-md-5.py-3(titulo="Fuentes formales" :icon="require('@/assets/bullets/icon-tab-c-3.svg')" )
        .row
          .col-md-6.col-lg-7.col-xl-8.mb-4.mb-md-0.order-2
            h4 Sector servicios: caso de empresa logística
            p.mb-0 Desafío: optimización de última milla.
            p Resultados: reducción del 30% en tiempos de entrega con cinco ideas seleccionadas.
    ...
    #t_2_4.titulo-segundo(data-aos='fade-right').my-5
      h2 #[span 2.4] Prototipado (desarrollo, pruebas y validación)
    .row.justify-content-center.mb-5
        ...
        .row.material-complementario
          .col-12.col-md-6.col-lg-7
            ...
            p.d-flex.my-4
              ...
              a(href="https://youtu.be/IdaVWfGHRFY?si=hqUUZXYaGKqCcmWQ" target="_blank" rel="noopener noreferrer") Negocios En Tu Mundo. [Negocios en Tm]. (2016, 9 de septiembre). 4 Etapas fundamentales para innovar en una pyme
